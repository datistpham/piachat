                          ...
                          }
                          {
                            toggleMakeFriend=== true && <>
                              ...
                              <div style={{width: "100%", marginBottom: 12}}>
                                <textarea autoFocus value={messageRequest} onChange={(e)=> setMessageRequest(e.target.value)} style={{width: "100%", fontSize: 16, padding: 10, resize: "none", border: "1px solid #e7e7e7", outlineColor: "orange", maxHeight: 200, overflow: "auto"}} rows={4} cols={4}>
